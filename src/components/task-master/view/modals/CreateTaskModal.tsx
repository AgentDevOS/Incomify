        ...
        <div className="space-y-6 p-6">
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="mb-2 font-semibold text-blue-900 dark:text-blue-100">{t('createTaskModal.tipTitle')}</h4>
                <p className="mb-3 text-sm text-blue-800 dark:text-blue-200">
                  {t('createTaskModal.tipDescription')}
                </p>
          ...
          <div className="border-t border-gray-200 pt-4 text-center dark:border-gray-700">
            ...
            >
              {t('createTaskModal.documentation')}
            </a>
          </div>
