              ...
              <div className="w-full max-w-lg rounded-xl border border-gray-200 bg-white p-6 text-left shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <ol className="space-y-4">
                  <li className="flex gap-4">
                    ...
                    <div>
                      <p className="mb-1 text-sm font-medium text-gray-900 dark:text-white">{t('gemini.steps.getKey.title')}</p>
                      <a
                  ...
                  <li className="flex gap-4">
                    ...
                    <div>
                      <p className="mb-1 text-sm font-medium text-gray-900 dark:text-white">{t('gemini.steps.configure.title')}</p>
                      <p className="mb-2 text-sm text-gray-600 dark:text-gray-400">{t('gemini.steps.configure.description')}</p>
