            ...
            <span className="flex items-center gap-1">
              ...
              {remoteStatus?.hasRemote && (
                <span className="flex items-center gap-0.5 text-xs">
                  {aheadCount > 0 && (
                    <span className="text-green-600 dark:text-green-400" title={t('header.remoteStatus.ahead', { count: aheadCount })}>
                      ↑{aheadCount}
                    </span>
                  )}
                  {behindCount > 0 && (
            ...
            <>
              {!remoteStatus.hasUpstream ? (
                ...
                >
                  ...
                  {!isMobile && <span>{isPublishing ? t('header.actions.publishing') : t('header.actions.publish')}</span>}
                </button>
              ) : (
                <>
                  ...
                  {behindCount > 0 && (
                    ...
                    >
                      ...
                      {!isMobile && <span>{isPulling ? t('header.actions.pulling') : t('header.actions.pull', { count: behindCount })}</span>}
                    </button>
                  )}
                  ...
                  {aheadCount > 0 && (
                    ...
                    >
                      ...
                      {!isMobile && <span>{isPushing ? t('header.actions.pushing') : t('header.actions.push', { count: aheadCount })}</span>}
                    </button>
                  )}
                </>
              )}
